...
function Thumbnail(props) {
    const [glare, setGlare] = useState("left-[-95%]") 
    return (
        <div className='w-full h-56 flex justify-center items-center overflow-hidden relative' onMouseEnter={() => setGlare("left-[100%] transition-[left] duration-[2500ms]")} onMouseLeave={() => setGlare("left-[-95%]")}>
